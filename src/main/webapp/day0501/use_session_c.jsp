...
<head>
<meta charset="UTF-8">
<title>day0501/use_session_c.jsp</title>
...
String name=(String)session.getAttribute("name");
if(name==null){
	response.sendRedirect("http://192.168.88.10/jsp_prj/day0501/use_session_a.jsp");
	return;
}//end if
--%>

<strong><%= name %></strong>님 안녕하세요???<br>
<a href="use_session_d.jsp">로그아웃하기</a>
</div><!--container-->
</main>
...
<%
System.out.println("--------------아래부분에 작성된 코드-----------------");
%>
