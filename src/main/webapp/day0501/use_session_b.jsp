...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    info="요청값을 받아서 세션에 넣는 페이지(이곳저곳에서 다 쓰려고~~)"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>day0501/use_session_b.jsp</title>
...
//세션에 값 할당(이미 세션 얻어와져있다)
// out.print( session );
SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
session.setAttribute("name", name);//use_session_d.jsp로 로그아웃 처리했다.
