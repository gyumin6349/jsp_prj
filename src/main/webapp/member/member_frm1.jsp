...
<div id="container">
	...
	<form action="member_process.jsp" name="frm" id="frm" method="post">
		<table>
			<tr>
				<th>* 아이디</th>
				<td><input type="text" name="id" readonly="readonly" class="inputBox" style="width:120px" style="display: none"> 
			...
			<tr>
				<th>연락처</th>
				<td colspan="3"><input type="text" class="inputBox" style="width:130px" name="tel"></td>
			</tr>
			<tr>
				<th>* 휴대폰</th>
				<td colspan="3"><input type="text"  name="phNum" class="inputBox" style="width:130px"><input
			...
			<tr>
				<th>자기소개</th>
				<td>
				<textarea style="width:500px;height:100px" id="selfIntro" name="selfIntro"></textarea> 
