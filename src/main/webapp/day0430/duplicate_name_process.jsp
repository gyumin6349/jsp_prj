...
//web parameter 받기 
//gender=M&lang=Java&lang=C%2FC%2B%2B&lang=PyThon&email=shjobo3%40gmail.com&email=dasdasd&email=dsadasdsada

//<input type ="radio"는 여러 개중 하나만 선택 가능하다. 하나만 parameter로 넘어온다.
String gender = request.getParameter("gender"); //<input type="radio">

//<input type="checkbox"는 여러개 가 선택가능하고, 같은 이름으로 여러개의 값이 입력된다.
//여러 개의 값을 저장할 수 있게 배열로 받는다.
String [] lang = request.getParameterValues("lang");

//<input type="text"일지라도 name이 같으면 배열로 처리 .
//text는 값이 입력ㄷ되지 않으면 ""rk dlqfurehlsek.
