...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    info="업무처리한결과를 받아와서,,, 응답하는 JSP(응답화면)"%>
    <%
    //업무처리결과를 받는다.
//  String name=request.getAttribute("name");
    String name=(String)request.getAttribute("name");//부모는 자식을 모르지만,,, 상속선에서 캐스팅된다
...
<head>
<meta charset="UTF-8">
<title><%=name %>, 어서오고!</title>

<!-- favicon 설정 -->
<link rel="shortcut icon" href="http://192.168.10.89/jsp_prj/common/images/favicon2.ico"/>
<!--  bootstrap CDN -->
...
function msg(){
	alert("이름이 없습니다!!!");
	location.href="forward_a.jsp";//나를 리로딩하는 효과
}//msg
...
<div id="container">
<select>
<option value="none">---관심과목 선택---</option>
